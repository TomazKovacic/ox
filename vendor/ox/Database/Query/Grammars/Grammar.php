<?php namespace ox\Database\Query\Grammars;

use ox\Database\Query\Builder;
use ox\Database\Grammar as BaseGrammar;
...
class Grammar extends BaseGrammar {
	 ...
	 * @var string
	 */
	//protected $wrapper = '"%s"'; //Laravel 5 nima več wrappwrja
