...
abstract class Grammar {
	...
	public function wrap($value)
	{
		...
		foreach ($segments as $key => $segment)
		{
			...
			{
				$wrapped[] = $this->wrapTable($segment); //A
			}
			else
			{
				$wrapped[] = $this->wrapValue($segment);//B
			}
		}
	 ...
	 * @return string
	 */
	protected function wrapValue__OLD($value)
	{
		return $value !== '*' ? sprintf($this->wrapper, $value) : $value;  //N88
	}
